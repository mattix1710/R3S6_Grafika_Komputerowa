...
//////////////////
// create a table of strings storing all file locations (each frame of animation has its own .obj file)
//
const NUM_OF_FRAMES = 60;

var leadingZeros = 6;
var prefix = './animSrc/characterAnim_';
var postfix = '.obj';
...
for(let i = 1; i <= NUM_OF_FRAMES; i++){
  ...
  while(i_aux.length < leadingZeros) i_aux = "0" + i_aux;
  anim[i-1] = prefix + i_aux + postfix;
}
...
async function startGL() 
{
  ...
  [indexes, vertexPosition, vertexNormal] = await LoadObj(anim[counter]);
...
var angleY = 0.0;
var angleX = 0.0;
var KameraPositionZ = -2.0;
var KameraPositionX = 0.0;
var KameraPositionY = -0.5;
